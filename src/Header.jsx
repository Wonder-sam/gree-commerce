...
export default function Header () {
    ...
    const [cartCount, setCartCount] = React.useState(()=>localStorage.getItem('cart')!==null?JSON.parse(localStorage.getItem('cart')).length:0)
        ...
        <div className='w-full flex flex-col'>
            <div className="w-full py-6 px-6 md:px-0 z-[2] text-xl self-center flex justify-between items-center">
                ...
                <div className="flex w-fit p-4 sm:mr-[2%] xl:mr-[10%] ml-[2%] md:ml-[5%] justify-center rounded-xl">
                    <p className="w-full font-[SatoshiBold] text-[#F4511E] font-bold text-2xl md:text-xl uppercase">Spice Haven</p>
                </div>
                <ul className="hidden md:flex w-[40%] text-base justify-between items-end text-black sm:mr-[5%] xl:mr-[15%]">
                    ...
                    <li><NavLink to="Recipes" className={({isActive})=>isActive? activeClassName: inactiveClassName}>Recipes</NavLink></li>
                    <li><NavLink to="ContactUs" className={({isActive})=>isActive? activeClassName: inactiveClassName}>Contact Us</NavLink></li>
                    <li><NavLink to="Cart" className={({isActive})=>isActive? activeClassName: inactiveClassName}>
                        <FiShoppingCart className='inline-block text-xl'/> {`(${cartCount})`}
                    </NavLink></li>
                </ul>
                {
                    user===null?
                    <NavLink to='Cart'><FiShoppingCart className=' sm:hidden text-2xl mr-3' /></NavLink>
                    :
                    null
                }
                {
                    ...
                    :
                    <div className='mr-[2%] md:mr-[5%] flex relative items-center'>
                        ...
                        <div className='bg-[#F4511E] rounded-full w-[50%]  p-4 aspect-square flex justify-center items-center'>
            ...
            <div ref={sideMenu} className='hidden z-[2] fixed top-0 w-full left-0 bottom-0 bg-white  py-16 px-8'>
                <div className="flex w-full justify-between mb-8">
                    <h4 className="w-[80%] text-left font-[STIXTwoTextBold] text-3xl sm:text-4xl text-[#333333]">Spice Haven.</h4>
                ...
                <ul className="justify-between items-end text-black leading-[4rem]">
                    ...
                    <li onClick={()=>closeMenu()}><NavLink to="Recipes" className={({isActive})=>isActive? activeClassName: inactiveClassName}>Recipes</NavLink></li>
                    <li onClick={()=>closeMenu()}><NavLink to="Cart" className={({isActive})=>isActive? activeClassName: inactiveClassName}><FiShoppingCart className='inline-block align-middle mr-2'/>My Cart</NavLink></li>
